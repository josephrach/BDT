...
<?php
    ...
    <p> Like Simple Org Chart? <a target="_blank" href="https://wordpress.org/support/plugin/simple-org-chart/reviews/#new-post">Leave a Review</a> and get 25% discount any <a href="https://www.wporgchart.com/#pricing">Pro license</a>.
    <?php
}
...
function general_admin_notice(){
    ...
    $cookieValue = $_COOKIE['org_nag'];
    if( !isset($_COOKIE['org_nag'])) {
        if($pagenow != 'post-new.php') {
            echo $_COOKIE['org_nag'];
